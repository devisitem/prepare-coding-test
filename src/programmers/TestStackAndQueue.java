...
public class TestStackAndQueue {
     ...
     * </ul>
     *
     * <p><a href="https://programmers.co.kr/learn/courses/30/lessons/42584" target="_blank" rel="noopener">주식 가격</a></p>
    ...
    public static void priceOfStock() {
        ...
        for(int i = 0;i < prices.length;i++) {
            while( ! stack.isEmpty() && prices[i] < prices[stack.peek()]) {
                int downIndex = stack.pop();
                answer[downIndex] = i - downIndex;
            }
            stack.push(i);
        }

        while( ! stack.isEmpty()) {
            int retainIndex = stack.pop();
            answer[retainIndex] = prices.length - retainIndex - 1;
        }
